...
def extract_clauses(state: ContractState):
    ...
    prompt = PromptTemplate(
        template="""
    You are a highly skilled legal assistant specialized in detailed contract analysis.
Your task is to carefully read the following legal document and extract its distinct clauses.

For each clause identified, please provide the following information:
...
2.  **Clause Text:** The complete text content of the clause.
